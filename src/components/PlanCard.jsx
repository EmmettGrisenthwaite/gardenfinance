  ...
  return (
    <form onSubmit={submit} className="flex items-center gap-2 px-4 py-2.5">
      <input autoFocus value={text} onChange={e => setText(e.target.value)}
        ...
        className="flex-1 bg-white/10 border border-white/[0.11] rounded-lg px-3 py-1.5 text-base md:text-xs text-white placeholder-white/35 focus:outline-none focus:border-emerald-400/50" />

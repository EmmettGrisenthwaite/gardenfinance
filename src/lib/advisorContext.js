...
// The user's situation, as every Advisor and Next Chapter caller sees it.
// Account-level records and monthly categories are treated as stronger evidence
// than onboarding answers — the user typed the former against real balances.

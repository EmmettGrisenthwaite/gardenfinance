...
export function getDataGaps({ profile, accounts = [], debts = [], goals = [], cashFlowItems = [] }) {
  ...
  if (unrated.length > 0) {
    ...
    gaps.push({
      ...
      cta: 'Add rate', href: '/?sheet=debts', sheet: 'debts',
    })
  }
  ...
  if (missingMinimums.length > 0) {
    ...
    gaps.push({
      ...
      cta: 'Add payment', href: '/?sheet=debts', sheet: 'debts',
    })
  }
  ...
  if (missingSubtype) {
    gaps.push({
      ...
      cta: 'Add type', href: '/?sheet=cash', sheet: 'cash',
    })
  }
  ...
  if (missingApy) {
    gaps.push({
      ...
      cta: 'Add APY', href: '/?sheet=cash', sheet: 'cash',
    })
  }
  ...
  if (isInvesting && investmentAccounts.length === 0) {
    gaps.push({
      ...
      cta: 'Add amount', href: '/?sheet=investment', sheet: 'investment',
    })
  }
  ...
  if (!num(p.monthly_income) && !detailedIncome) {
    gaps.push({
      ...
      cta: 'Add income', href: '/?sheet=plan', sheet: 'plan',
    })
  }
